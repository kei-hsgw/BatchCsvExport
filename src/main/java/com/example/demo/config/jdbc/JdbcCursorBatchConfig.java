...
public class JdbcCursorBatchConfig extends BaseConfig {
	...
	/** SELECT用のSQL */
	private static final String SELECT_EMPLOYEE_SQL = "SELECT id, name, age, gender FROM employee WHERE gender = ?";
	...
	/** Stepの生成 */
	@Bean
	public Step exportJdbcCurcorStep() throws Exception {
